	...
	<body>
		...
		<div class="sidebar">
		   ...
		   <div class="menuTitle">ÁREA ADMINISTRATIVA</div><br>
			...
			<!-- Conteúdo da página-->	
		<br><h1 class="titulo">Cadastrar usuário</h1>
		<div class="conteudo">
		<br>
				<form action="http://localhost:8080/SistemaAcademico-web/ServletUsuario?cmd=incluir" method="get">
					 ...
					 <table>
						...
						<tr>	
						 ...
						 <tr>
							...
							<input type="submit" value="Cadastrar" class="btnset"></td>
						 </tr>
					</table>
				</form>	          
