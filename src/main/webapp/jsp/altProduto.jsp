	 ...
	 <jsp:useBean id="produto" scope="session" class="br.edu.astrotoystore.model.Produto" />
		...
		<div class="sidebar">
		   ...
		   <div class="menuTitle">ÁREA ADMINISTRATIVA</div><br>
			...
			<!-- Conteúdo da página-->	
		<br><h1 class="titulo">Alterar produto</h1>
		<div class="conteudo">
		<br>
	          	...
	          	<form action="ServletProduto?cmd=atualizar" method="post">
					 <table>
						...
						<td><input type="text" name="nomeProduto" size="30" maxlenght="10" value="<%=produto.getNomeProduto()%>"/></td>
						</tr>	
						
						<tr>
						<th><h4>Código da categoria do produto:</h4></th>
						<td><input type="text" name="idCategoria" size="30" maxlenght="10" value="<%=produto.getIdCategoria()%>"/></td>
						</tr>
							
						<tr>
						<th><h4>Preço unitário:</h4></th>
						<td><input type="text" name="precoUnitario" size="30" maxlenght="10" value="<%=produto.getPrecoUnitario()%>" /></td>
						</tr>
							
						<tr>
						<th><h4>URL da imagem:</h4></th>
						<td><input type="text" name="imgProduto" size="30" maxlenght="10" value="<%=produto.getImgProduto()%>" /></td>
						</tr>
							 
						<tr>
						<th><h4>Descrição do produto:</h4></th>
						<td><textarea name="descricao" style="width: 100%; height: 60px;"><%=produto.getDescricao()%></textarea></td>
						</tr>
						 
						<tr>
						<td colspan="2" align="center"><br/> 
						<input type="submit" value="Alterar" class="btnset"></td>
						</tr>
