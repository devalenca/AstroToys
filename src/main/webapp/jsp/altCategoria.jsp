...
<html>
   ...
   <jsp:useBean id="categoria" scope="session" class="br.edu.astrotoystore.model.Categoria" />
		...
		<div class="sidebar">
		   ...
		   <div class="menuTitle">ÁREA ADMINISTRATIVA</div><br>
			...
			<!-- Conteúdo da página-->	
		<br><h1 class="titulo">Alterar categoria</h1>
		<div class="conteudo">
		<br>	        
	       ...
	       <form action="ServletCategoria?cmd=atualizar" method="post">
				<table>
					...
					<td><input type="text" name="nomeCategoria" size="30" maxlenght="10" value="<%=categoria.getNomeCategoria()%>"/></td>
					</tr>
								 
					<tr>
					<th><h4>Faixa etária: </h4></th>
					<td><input type="text" name="faixa_etaria" size="30" maxlenght="10"  value="<%=categoria.getFaixa_etaria()%>"/></td>
					</tr>
					
					<tr>
					<th><h4>Imagem da categoria: </h4></th>
					<td><input type="text" name="imgCategoria" size="30" maxlenght="10"  value="<%=categoria.getImgCategoria()%>"/></td>
					</tr>
