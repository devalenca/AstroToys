...
<html>
	...
	<body>
		...
		<div class="sidebar">
			...
			<!-- Conteúdo da página-->		
		<br><h1 class="titulo">Administrar categorias</h1>
		<div class="conteudo">
						...
						<table>
							...
							<tr>
								<th colspan="6" style="text-align: center;">
									<a href="/SistemaAcademico-web/jsp/cadCategoria.jsp"><img src="icon/novo_.png" style="width: 20px;"> Adicionar nova categoria</a>
								</th>
							</tr>
							...
							<tr>
								...
								<td style="text-align: center;"><img src="<%=c.getImgCategoria()%>" style="width:50px;" ></td>
