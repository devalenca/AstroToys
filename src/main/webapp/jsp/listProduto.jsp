	...
	<body>
		...
		<div class="sidebar">
		  ...
		  <div class="menuTitle">ÁREA ADMINISTRATIVA</div><br>
			...
			<!-- Conteúdo da página-->		
		<br><h1 class="titulo">Administrar produtos</h1>
		<div class="conteudo">
					<% 
						...
						<table>
							...
							<tr>
								<th colspan="8" style="text-align: center;">
									<a href="/SistemaAcademico-web/jsp/cadProduto.jsp"><img src="icon/novo_.png" style="width: 20px;"> Adicionar novo produto</a>
								</th>
							</tr>
